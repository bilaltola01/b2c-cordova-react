...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Step = __webpack_require__(188);
	...
	var App = _react2.default.createClass({
		...
		getInitialState: function getInitialState() {
			return _step2.default.getState();
		},
		componentWillMount: function componentWillMount() {
			_step2.default.addChangeListener(this.updateStateFromStore);
		},
		componentWillUnmount: function componentWillUnmount() {
			_step2.default.removeChangeListener(this.updateStateFromStore);
		},
		updateStateFromStore: function updateStateFromStore() {
			this.setState(_step2.default.getState());
		},
		renderCurrentStep: function renderCurrentStep() {
			var _state = this.state,
			    currentStep = _state.currentStep,
			    availableSteps = _state.availableSteps,
			    totalSteps = _state.totalSteps;

			return currentStep === 0 ? _react2.default.createElement(_Start2.default, { key: 'start' }) : _react2.default.createElement(_Step2.default, { key: 'step-' + currentStep,
				currentStep: currentStep,
				availableSteps: availableSteps,
				totalSteps: totalSteps });
		},
		render: function render() {
			var transitionName = this.state.direction === 'next' ? 'step' : 'step-prev';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/css-loader/index.js?url=false!./main.css", function() {
				var newContent = require("!!../../node_modules/css-loader/index.js?url=false!./main.css");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var xhr = __webpack_require__(172);
	var constants = __webpack_require__(179);

	var StepStore = new Store();

	var _currentStep = 0;
	var _availableSteps = 1;
	var _totalSteps = constants.TOTAL_STEPS;
	var _direction = 'next';

	var fetchAvailableStep = function fetchAvailableStep(callback) {
		xhr({
			...
			try {
				...
				var newStep = data.availableSteps || 1;
	...
	StepStore.extend({
		...
		update: function update() {
			...
			var lastCurrentStep = _currentStep;
			fetchAvailableStep(function (err, newStep) {
				if (!err) _this.setCurrentStep(newStep);
				window.updateTimeout = setTimeout(function () {
					return StepStore.update();
				}, 1000);
			});
		},
...
/***/ (function(module, exports, __webpack_require__) {
	...
	"use strict";
	var window = __webpack_require__(173)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reactTappable = __webpack_require__(181);
	...
	var Start = _react2.default.createClass({
		displayName: 'Start',
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					{ className: 'button-getstarted', onTap: this.start },
					'Get Started'
				)
			);
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TappableMixin = __webpack_require__(182);
	var PinchableMixin = __webpack_require__(183);
	var getComponent = __webpack_require__(184);
	var touchStyles = __webpack_require__(185);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/css-loader/index.js?url=false!./start.css", function() {
				var newContent = require("!!../../node_modules/css-loader/index.js?url=false!./start.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	...
	var Step = _react2.default.createClass({
		...
		render: function render() {
			var _props = this.props,
			    ...
			    availableSteps = _props.availableSteps,
			    totalSteps = _props.totalSteps;
			...
			return _react2.default.createElement(
				'div',
				{ className: 'step', style: style },
				_react2.default.createElement(_reactTappable2.default, { className: 'button button-previous', onTap: this.prev }),
				_react2.default.createElement(_reactTappable2.default, { className: nextClass, onTap: this.next })
			);
		}
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/css-loader/index.js?url=false!./step.css", function() {
				var newContent = require("!!../../node_modules/css-loader/index.js?url=false!./step.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
